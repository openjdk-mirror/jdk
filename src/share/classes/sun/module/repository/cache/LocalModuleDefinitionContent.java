...
/**
 * Local module definition content.
 *
 * @since 1.7
 */
final class LocalModuleDefinitionContent extends CacheModuleDefinitionContent {

    // ModuleDefInfo which this module definition content belongs
    private final LocalModuleDefInfo mdInfo;

    /**
     * Constructs a new local cache module definition content.
     */
    LocalModuleDefinitionContent(LocalModuleDefInfo mdInfo) {
