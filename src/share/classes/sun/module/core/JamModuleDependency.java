...
/**
 * This class represents a module-level's import dependency in a module
 * definition.
 * <p>
 ...
 * @serial include
 */
public class JamModuleDependency implements ModuleDependency {
    ...
    /**
     * Constructs a {@code JamModuleDependency} object.
     *
     ...
     */
    public JamModuleDependency(String name,
     ...
     * with this {@code JamModuleDependency}.
     *
     ...
     * associated with this {@code JamModuleDependency}.
     *
    ...
    /**
     * Compare two {@code JamModuleDependency} objects for equality. The result is
     * {@code true} if and only if the argument is not {@code null} and is a
     * {@code JamModuleDependency} object that imported type, name, version
     * constraint, reexport, optional, and attributes are the same as those of
     * this {@code JamModuleDependency}.
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof JamModuleDependency))
            return false;

        JamModuleDependency dep = (JamModuleDependency) obj;
    ...
    /**
     * Returns a hash code for this {@code JamModuleDependency}.
     *
     * @return a hash code value for this {@code JamModuleDependency}.
     */
    @Override
    public int hashCode() {
        int result = 17;
     ...
     * {@code JamModuleDependency}.
     *
     * @return a string representation of the {@code JamModuleDependency} object.
     */
    @Override
    public String toString() {
        StringBuilder builder = new StringBuilder();

        builder.append("ModuleDependency[name=");
        builder.append(name);
