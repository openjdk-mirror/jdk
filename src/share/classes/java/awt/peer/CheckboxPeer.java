...
public interface CheckboxPeer extends ComponentPeer {
    ...
    /**
     * Sets the state of the checkbox to be checked (<code>true</code>) or
     * unchecked (<code>false</code>).
     *
     ...
     * of <code>null</code> removes this checkbox from any checkbox group.
     *
     * @param g the checkbox group to set, or <code>null</code> when this
     ...
     * <code>null</code> means that no label should be displayed.
     *
     * @param label the label to be displayed on the checkbox, or
     *              <code>null</code> when no label should be displayed.
     */
