...
/** 
 * Implements the Haiku necessary file system functions. This was heavily
 * based upon Solaris, with some hints taken from the win32 source.
 * 
 * @author Bryan Varner
 * @version 1.0
 */
class HaikuFileSystem extends FileSystem {

    private final char slash;
    private final char colon;
    private final String javaHome;
    
    public HaikuFileSystem() {
        slash = 
    ...
    public File[] listRoots() {
        try {
            ...
            String[] sroots = listRoots0();
            File[] froots = new File[sroots.length];
            for (int root = 0; root < sroots.length; root++)
                froots[root] = new File(sroots[root]);
            return froots;
    ...
    public native String[] listRoots0();
