...
public class MimeTable implements FileNameMap {
	...
	private void addNativeTypes() {
		_addNativeTypes();
	}
	private native void _addNativeTypes();
	...
	void parse(String type, String attrs) {
		...
		fillNativeFields(newEntry);
	}

	private void fillNativeFields(MimeEntry entry) {
		_fillNativeFields(entry);
	}
	private native void _fillNativeFields(MimeEntry entry);
