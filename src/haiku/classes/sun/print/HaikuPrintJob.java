...
public class HaikuPrintJob implements CancelablePrintJob {
    ...
    private HaikuPrintService service;
    ...
    HaikuPrintJob(HaikuPrintService service) {
    ...
    private boolean startPrintRawData(String printerName) {
    	throw new RuntimeException("TODO: HaikuPrintJob.startPrintRawData");
    }
    private boolean printRawData(byte[] data, int count) {
    	throw new RuntimeException("TODO: HaikuPrintJob.printRawData");
    }
    private boolean endPrintRawData() {
    	throw new RuntimeException("TODO: HaikuPrintJob.endPrintRawData");
    }
