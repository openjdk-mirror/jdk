...
public final class Normalizer {
   ...
   private Normalizer() {};
    ...
    public static class Form {
         ...
         */
        public static final Form NFD = new Form();

        /**
         * Canonical decomposition, followed by canonical composition.
         */
        public static final Form NFC = new Form();

        /**
         * Compatibility decomposition.
         */
        public static final Form NFKD = new Form();

        /**
         * Compatibility decomposition, followed by canonical composition.
         */
        public static final Form NFKC = new Form();
    }
    ...
    public static String normalize(CharSequence src, Form form) {
    	throw new UnsupportedOperationException("return NormalizerBase.normalize(src.toString(), form);");
    }
    ...
    public static boolean isNormalized(CharSequence src, Form form) {
        throw new UnsupportedOperationException("return NormalizerBase.isNormalized(src.toString(), form);");
    }
}
