...
public class RoundingMode {
         ...
         *</table>
         */
    public static final RoundingMode UP = new RoundingMode(BigDecimal.ROUND_UP);
         ...
         *</table>
         */
    public static final RoundingMode DOWN = new RoundingMode(BigDecimal.ROUND_DOWN);
         ...
         *</table>
         */
    public static final RoundingMode CEILING = new RoundingMode(BigDecimal.ROUND_CEILING);
         ...
         *</table>
         */
    public static final RoundingMode FLOOR = new RoundingMode(BigDecimal.ROUND_FLOOR);
         ...
         *</table>
         */
    public static final RoundingMode HALF_UP = new RoundingMode(BigDecimal.ROUND_HALF_UP);
         ...
         *</table>
         */
    public static final RoundingMode HALF_DOWN = new RoundingMode(BigDecimal.ROUND_HALF_DOWN);
         ...
         *</table>
         */
    public static final RoundingMode HALF_EVEN = new RoundingMode(BigDecimal.ROUND_HALF_EVEN);
         ...
         *</table>
         */
    public static final RoundingMode UNNECESSARY = new RoundingMode(BigDecimal.ROUND_UNNECESSARY);
    ...
    public static RoundingMode valueOf(String string) {
		...
		if ("CEILING".equals(string)) {
            return CEILING;
		}
		if ("FLOOR".equals(string)) {
            return FLOOR;
		}
		if ("HALF_UP".equals(string)) {
            return HALF_UP;
		}
		if ("HALF_DOWN".equals(string)) {
			return HALF_DOWN;
		}
		if ("HALF_EVEN".equals(string)) {
            return HALF_EVEN;
		}
		if ("UNNECESSARY".equals(string)) {
            return UNNECESSARY;
		}
		return null;
    }
