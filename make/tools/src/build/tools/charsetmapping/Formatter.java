...
public final class Formatter {
    ...
    private void init(StringBuilder a, Locale l) {
        this.a = a;
        this.l = l;
        setZero();
    }
     ...
     */
    public Formatter(StringBuilder a) {
        if (a == null)
            a = new StringBuilder();
     ...
     *         is applied.
     */
    public Formatter(StringBuilder a, Locale l) {
        if (a == null)
            a = new StringBuilder();
        init(a, l);
    }
    ...
    public Formatter(String fileName) throws FileNotFoundException {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(fileName))), Locale.getDefault());");
    }
    ...
    public Formatter(String fileName, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(fileName), csn)), l);");
    }
    ...
    public Formatter(File file) throws FileNotFoundException {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file))), Locale.getDefault());");
    }
    ...
    public Formatter(File file, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), csn)), l);");
    }
    ...
    public Formatter(PrintStream ps) {
        ...
        System.err.println("init((Appendable)ps, Locale.getDefault());");
    }
    ...
    public Formatter(OutputStream os) {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(os)), Locale.getDefault());");
    }
    ...
    public Formatter(OutputStream os, String csn, Locale l)
        throws UnsupportedEncodingException
    {
    	System.err.println("init(new BufferedWriter(new OutputStreamWriter(os, csn)), l);");
    }
...
//          System.out.println(((FormatString) al.get(j)).toString());
    ...
    public static class BigDecimalLayoutForm {
    	public static final BigDecimalLayoutForm SCIENTIFIC = new BigDecimalLayoutForm();
    	public static final BigDecimalLayoutForm DECIMAL_FLOAT = new BigDecimalLayoutForm();
    };
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void checkGeneral() {
            ...
            checkBadFlags(new Flags[] { Flags.PLUS, Flags.LEADING_SPACE, Flags.ZERO_PAD,
        ...
        private void checkDateTime() {
            ...
            checkBadFlags(new Flags[] { Flags.ALTERNATE, Flags.PLUS, Flags.LEADING_SPACE,
        ...
        private void checkInteger() {
            ...
            if (c == Conversion.DECIMAL_INTEGER)
                checkBadFlags(new Flags[] { Flags.ALTERNATE });
            else if (c == Conversion.OCTAL_INTEGER)
                checkBadFlags(new Flags[] { Flags.GROUP });
            else
                checkBadFlags(new Flags[] { Flags.GROUP });
        }
        ...
        private void checkFloat() {
            ...
            if (c == Conversion.DECIMAL_FLOAT) {
                ...
                checkBadFlags(new Flags[] { Flags.PARENTHESES, Flags.GROUP });
        ...
        private void print(long value, Locale l) throws IOException {
            ...
            if (c == Conversion.DECIMAL_INTEGER) {
                ...
                checkBadFlags(new Flags[] { Flags.PARENTHESES, Flags.LEADING_SPACE,
                              Flags.PLUS
                });
            ...
            throws IOException
        {
            if (c == Conversion.SCIENTIFIC) {
            	throw new UnsupportedOperationException("SCIENTIFIC");
...
////                sb.append(localizedMagnitude(null, tmp, flags, -1, l));
            	...
            	throw new UnsupportedOperationException("decFloat");
////                // Create a new FormattedFloatingDecimal with the desired
////                // precision.
////                int prec = (precision == -1 ? 6 : precision);
////
...
////                localizedMagnitude(sb, mant, f, newW, l);
            	...
            	throw new UnsupportedOperationException("generals");
////                int prec = precision;
////                if (precision == -1)
////                    prec = 6;
////                else if (precision == 0)
...
////                }
        ...
        private String hexDouble(double d, int prec) {
            ...
            if(!FpUtils.isFinite(d) || d == 0.0 || prec == 0 || prec >= 13)
                // remove "0x"
                throw new UnsupportedOperationException("hexyDboule");
////                return Double.toHexString(d).substring(2);
                ...
                if (Double.isInfinite(result) ) {
                	...
                	throw new UnsupportedOperationException("hexstring");
...
////                sb.append(localizedMagnitude(null, tmp, flags, -1, l));
            	...
            	throw new UnsupportedOperationException("DECIMALFLOAT");
////                // Create a new BigDecimal with the desired precision.
////                int prec = (precision == -1 ? 6 : precision);
////                int scale = value.scale();
////
