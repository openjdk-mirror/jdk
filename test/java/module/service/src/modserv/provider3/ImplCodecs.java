 ...
 */
@ServiceProvider
public class ImplCodecs extends CodecSet {

    /** Creates a new instance of ImplCodecs */
    public ImplCodecs() {
    }

    public Encoder getEncoderFor(String name) {
        if ("whiz".equals(name)) {
            return new BarEncoder();
        }
        return null;
    }

    static class BarEncoder extends Encoder {
        public BarEncoder() {
            super("whiz");
        }

        public String  encode(String s) {
            return "whiz-provider3.ImplCodecs|" + s;
        }
    }
}
